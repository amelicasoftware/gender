...
export class MapComponent implements OnInit {
  ...
  ngAfterViewInit(): void {
    ...
    imageSeries.dataSource.url = this.urlProject + 'assets/json/paisesGenero.json';
